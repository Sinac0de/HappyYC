...
export type AllSanitySchemaTypes = Startup | Playlist | Author | Markdown | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
export declare const internalGroqTypeReferenceTo: unique symbol;
// Source: sanity/lib/queries.ts
// Variable: STARTUPS_QUERY
// Query: *[_type == "startup" && defined(slug.current) && ( !defined($search) || $search == "" || title match "*" + $search + "*" || category match "*" + $search + "*" || author->name match "*" + $search + "*" )] | order(_createdAt desc){  _id,  title,  slug,  _createdAt,  _updatedAt,  _rev,  author ->{      _id, name, image, bio  },  views,  description,  category,  image,  pitch}
