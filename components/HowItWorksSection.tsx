  ...
  const steps = [
    {
      ...
      description: "Sign up and craft a compelling pitch for your startup idea in minutes.",
      icon: "✍️"
    },
    {
      title: "Share & Vote",
      description: "Share your pitch with the community and vote on other innovative ideas.",
      icon: "📢"
    },
    {
      title: "Get Feedback",
      description: "Receive valuable feedback from experienced entrepreneurs and potential users.",
      icon: "💬"
    },
    {
      title: "Grow & Connect",
      description: "Connect with collaborators, mentors, and investors to bring your idea to life.",
      icon: "🚀"
    }
  ];
    ...
    <section id="how-it-works" className="py-20 px-6 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-30-bold mb-4 text-black dark:text-white">How It Works</h2>
            ...
            >
              <div className="bg-white dark:bg-gray-800 border-[5px] border-black dark:border-gray-600 rounded-[22px] p-6 h-full transition-all duration-300 hover:shadow-300 dark:hover:shadow-300-dark hover:-translate-y-2">
                ...
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-20-medium text-black dark:text-white">{step.title}</h3>
                </div>
